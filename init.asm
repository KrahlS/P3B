...
main(void)
{
  ...
  19:	e8 ab 03 00 00       	call   3c9 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 ce 03 00 00       	call   401 <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 c2 03 00 00       	call   401 <dup>
  ...
  52:	e8 99 04 00 00       	call   4f0 <printf>
    pid = fork();
  57:	e8 25 03 00 00       	call   381 <fork>
    if(pid < 0){
  ...
  70:	e8 1c 03 00 00       	call   391 <wait>
  ...
  9a:	e8 51 04 00 00       	call   4f0 <printf>
      exit();
  9f:	e8 e5 02 00 00       	call   389 <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 d8 0b 00 00       	push   $0xbd8
  ab:	68 46 08 00 00       	push   $0x846
  b0:	e8 0c 03 00 00       	call   3c1 <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 2d 04 00 00       	call   4f0 <printf>
      exit();
  c3:	e8 c1 02 00 00       	call   389 <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 18 08 00 00       	push   $0x818
  d2:	e8 fa 02 00 00       	call   3d1 <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 18 08 00 00       	push   $0x818
  e0:	e8 e4 02 00 00       	call   3c9 <open>
...
stat(const char *n, struct stat *st)
{
 ...
 28d:	e8 37 01 00 00       	call   3c9 <open>
  if(fd < 0)
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 3a 01 00 00       	call   3e1 <fstat>
  close(fd);
 2a7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2aa:	89 c6                	mov    %eax,%esi
  close(fd);
 2ac:	e8 00 01 00 00       	call   3b1 <close>
  return r;
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 535:	57                   	push   %edi
 536:	56                   	push   %esi
 537:	e8 6d fe ff ff       	call   3a9 <write>
 ...
 58e:	e8 16 fe ff ff       	call   3a9 <write>
        putc(fd, c);
 ...
 59f:	57                   	push   %edi
 5a0:	56                   	push   %esi
 5a1:	e8 03 fe ff ff       	call   3a9 <write>
        putc(fd, c);
 ...
 60b:	57                   	push   %edi
 60c:	56                   	push   %esi
 60d:	e8 97 fd ff ff       	call   3a9 <write>
        while(*s != 0){
 ...
 64c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 64f:	e8 55 fd ff ff       	call   3a9 <write>
        ap++;
...
free(void *ap)
{
 ...
 691:	a1 e0 0b 00 00       	mov    0xbe0,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 e0 0b 00 00    	mov    %edx,0xbe0
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 e0 0b 00 00    	mov    %edx,0xbe0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d e0 0b 00 00    	mov    0xbe0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d e0 0b 00 00    	mov    0xbe0,%edi
 ...
 783:	e8 89 fc ff ff       	call   411 <sbrk>
  if(p == (char*)-1)
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 e0 0b 00 00    	mov    0xbe0,%edx
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 e0 0b 00 00 e4 	movl   $0xbe4,0xbe0
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf e4 0b 00 00       	mov    $0xbe4,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 e4 0b 00 00 e4 	movl   $0xbe4,0xbe4
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
