...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 2e 39 00 00       	call   3959 <open>
    ...
    exit();
      40:	e8 d4 38 00 00       	call   3919 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 03 39 00 00       	call   3959 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 e3 38 00 00       	call   3941 <close>
  ...
  exit();
     10d:	e8 07 38 00 00       	call   3919 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 33 38 00 00       	call   3989 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 fb 37 00 00       	call   3969 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 07 38 00 00       	call   3989 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 fc 5e 00 00    	push   0x5efc
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 fc 5e 00 00    	push   0x5efc
     1ae:	e8 cd 38 00 00       	call   3a80 <printf>
    exit();
     1b3:	e8 61 37 00 00       	call   3919 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 f3 3d 00 00       	push   $0x3df3
     1bf:	ff 35 fc 5e 00 00    	push   0x5efc
     1c5:	e8 b6 38 00 00       	call   3a80 <printf>
    exit();
     1ca:	e8 4a 37 00 00       	call   3919 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 d7 3d 00 00       	push   $0x3dd7
     1d6:	ff 35 fc 5e 00 00    	push   0x5efc
     1dc:	e8 9f 38 00 00       	call   3a80 <printf>
    exit();
     1e1:	e8 33 37 00 00       	call   3919 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 b6 3d 00 00       	push   $0x3db6
     1ed:	ff 35 fc 5e 00 00    	push   0x5efc
     1f3:	e8 88 38 00 00       	call   3a80 <printf>
    exit();
     1f8:	e8 1c 37 00 00       	call   3919 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 fc 5e 00 00    	push   0x5efc
     211:	e8 6a 38 00 00       	call   3a80 <printf>
  pid = fork();
     216:	e8 f6 36 00 00       	call   3911 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 4c 37 00 00       	call   3981 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 3c 37 00 00       	call   3989 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 04 37 00 00       	call   3969 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 a8 36 00 00       	call   3919 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 a4 36 00 00       	call   3921 <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 26 3e 00 00       	push   $0x3e26
     285:	ff 35 fc 5e 00 00    	push   0x5efc
     ...
     2a0:	ff 35 fc 5e 00 00    	push   0x5efc
     2a6:	e8 d5 37 00 00       	call   3a80 <printf>
      exit();
     2ab:	e8 69 36 00 00       	call   3919 <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 e9 4c 00 00       	push   $0x4ce9
     2b7:	ff 35 fc 5e 00 00    	push   0x5efc
     2bd:	e8 be 37 00 00       	call   3a80 <printf>
    exit();
     2c2:	e8 52 36 00 00       	call   3919 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 a8 3d 00 00       	push   $0x3da8
     2ce:	ff 35 fc 5e 00 00    	push   0x5efc
     2d4:	e8 a7 37 00 00       	call   3a80 <printf>
      exit();
     2d9:	e8 3b 36 00 00       	call   3919 <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 12 3e 00 00       	push   $0x3e12
     2e5:	ff 35 fc 5e 00 00    	push   0x5efc
     2eb:	e8 90 37 00 00       	call   3a80 <printf>
      exit();
     2f0:	e8 24 36 00 00       	call   3919 <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 12 36 00 00       	call   3959 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 64 35 00 00       	call   3919 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 e9 4c 00 00       	push   $0x4ce9
     3bc:	ff 35 fc 5e 00 00    	push   0x5efc
     3c2:	e8 b9 36 00 00       	call   3a80 <printf>
    exit();
     3c7:	e8 4d 35 00 00       	call   3919 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 4d 3e 00 00       	push   $0x3e4d
     3d3:	ff 35 fc 5e 00 00    	push   0x5efc
     3d9:	e8 a2 36 00 00       	call   3a80 <printf>
    exit();
     3de:	e8 36 35 00 00       	call   3919 <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 61 3e 00 00       	push   $0x3e61
     3ea:	ff 35 fc 5e 00 00    	push   0x5efc
     3f0:	e8 8b 36 00 00       	call   3a80 <printf>
    exit();
     3f5:	e8 1f 35 00 00       	call   3919 <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 fc 5e 00 00    	push   0x5efc
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 35 35 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 0d 35 00 00       	call   3941 <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 a5 3e 00 00       	push   $0x3ea5
     43d:	e8 17 35 00 00       	call   3959 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 fc 5e 00 00    	push   0x5efc
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 fc 5e 00 00    	push   0x5efc
     46e:	e8 0d 36 00 00       	call   3a80 <printf>
    exit();
     473:	e8 a1 34 00 00       	call   3919 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 b2 3e 00 00       	push   $0x3eb2
     47f:	ff 35 fc 5e 00 00    	push   0x5efc
     485:	e8 f6 35 00 00       	call   3a80 <printf>
    exit();
     48a:	e8 8a 34 00 00       	call   3919 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 fc 5e 00 00    	push   0x5efc
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 a0 34 00 00       	call   3959 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 fc 5e 00 00    	push   0x5efc
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 49 34 00 00       	call   3939 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 2d 34 00 00       	call   3939 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 fc 5e 00 00    	push   0x5efc
     52e:	e8 4d 35 00 00       	call   3a80 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 06 34 00 00       	call   3941 <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 ef 3e 00 00       	push   $0x3eef
     544:	e8 10 34 00 00       	call   3959 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 fc 5e 00 00    	push   0x5efc
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 b5 33 00 00       	call   3931 <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 fc 5e 00 00    	push   0x5efc
     598:	e8 e3 34 00 00       	call   3a80 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 9c 33 00 00       	call   3941 <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 ef 3e 00 00 	movl   $0x3eef,(%esp)
     5ac:	e8 b8 33 00 00       	call   3969 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 fc 5e 00 00    	push   0x5efc
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 fc 5e 00 00    	push   0x5efc
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 c0 32 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 70 32 00 00       	call   3939 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 56 32 00 00       	call   3941 <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 37 40 00 00       	push   $0x4037
     6f4:	e8 60 32 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 f7 31 00 00       	call   3931 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 eb 31 00 00       	call   3941 <close>
  if(unlink("big") < 0){
     756:	c7 04 24 37 40 00 00 	movl   $0x4037,(%esp)
     75d:	e8 07 32 00 00       	call   3969 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 fc 5e 00 00    	push   0x5efc
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 fc 5e 00 00    	push   0x5efc
     857:	e8 24 32 00 00       	call   3a80 <printf>
  name[0] = 'a';
     85c:	c6 05 30 86 00 00 61 	movb   $0x61,0x8630
  name[2] = '\0';
     863:	83 c4 10             	add    $0x10,%esp
     866:	c6 05 32 86 00 00 00 	movb   $0x0,0x8632
  for(i = 0; i < 52; i++){
     86d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     870:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     873:	88 1d 31 86 00 00    	mov    %bl,0x8631
  for(i = 0; i < 52; i++){
     879:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     87c:	68 02 02 00 00       	push   $0x202
     881:	68 30 86 00 00       	push   $0x8630
     886:	e8 ce 30 00 00       	call   3959 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 ae 30 00 00       	call   3941 <close>
  for(i = 0; i < 52; i++){
     893:	83 c4 10             	add    $0x10,%esp
     896:	80 fb 64             	cmp    $0x64,%bl
     899:	75 d5                	jne    870 <createtest+0x30>
  name[0] = 'a';
     89b:	c6 05 30 86 00 00 61 	movb   $0x61,0x8630
  name[2] = '\0';
     8a2:	bb 30 00 00 00       	mov    $0x30,%ebx
     8a7:	c6 05 32 86 00 00 00 	movb   $0x0,0x8632
  for(i = 0; i < 52; i++){
     8ae:	66 90                	xchg   %ax,%ax
    unlink(name);
     8b0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8b3:	88 1d 31 86 00 00    	mov    %bl,0x8631
  for(i = 0; i < 52; i++){
     8b9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8bc:	68 30 86 00 00       	push   $0x8630
     8c1:	e8 a3 30 00 00       	call   3969 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 fc 5e 00 00    	push   0x5efc
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 63 30 00 00       	call   3989 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 4b 30 00 00       	call   3989 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 17 30 00 00       	call   3969 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 fc 5e 00 00    	push   0x5efc
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 fc 5e 00 00    	push   0x5efc
     97e:	e8 fd 30 00 00       	call   3a80 <printf>
    exit();
     983:	e8 91 2f 00 00       	call   3919 <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 a1 40 00 00       	push   $0x40a1
     98f:	ff 35 fc 5e 00 00    	push   0x5efc
     995:	e8 e6 30 00 00       	call   3a80 <printf>
    exit();
     99a:	e8 7a 2f 00 00       	call   3919 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 90 40 00 00       	push   $0x4090
     9a6:	ff 35 fc 5e 00 00    	push   0x5efc
     9ac:	e8 cf 30 00 00       	call   3a80 <printf>
    exit();
     9b1:	e8 63 2f 00 00       	call   3919 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 7d 40 00 00       	push   $0x407d
     9bd:	ff 35 fc 5e 00 00    	push   0x5efc
     9c3:	e8 b8 30 00 00       	call   3a80 <printf>
    exit();
     9c8:	e8 4c 2f 00 00       	call   3919 <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 fc 5e 00 00    	push   0x5efc
     9e1:	e8 9a 30 00 00       	call   3a80 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 00 5f 00 00       	push   $0x5f00
     9ed:	68 8d 3e 00 00       	push   $0x3e8d
     9f2:	e8 5a 2f 00 00       	call   3951 <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 fc 5e 00 00    	push   0x5efc
     a0d:	e8 6e 30 00 00       	call   3a80 <printf>
    exit();
     a12:	e8 02 2f 00 00       	call   3919 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 df 2e 00 00       	call   3941 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 b4 2e 00 00       	call   3931 <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 65 2e 00 00       	call   3941 <close>
     ...
     b11:	e8 23 2e 00 00       	call   3939 <write>
    ...
    exit();
     b28:	e8 ec 2d 00 00       	call   3919 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 00 2e 00 00       	call   3941 <close>
    wait();
     b41:	e8 db 2d 00 00       	call   3921 <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 14 2f 00 00       	call   3a80 <printf>
      exit();
     b6c:	e8 a8 2d 00 00       	call   3919 <exit>
    ...
    exit();
     b7f:	e8 95 2d 00 00       	call   3919 <exit>
    ...
    exit();
     b92:	e8 82 2d 00 00       	call   3919 <exit>
     ...
     ba0:	e8 db 2e 00 00       	call   3a80 <printf>
        exit();
     ba5:	e8 6f 2d 00 00       	call   3919 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 47 2d 00 00       	call   3911 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 32 2d 00 00       	call   3911 <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 2d 2d 00 00       	call   3929 <pipe>
  pid3 = fork();
     bfc:	e8 10 2d 00 00       	call   3911 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 03 2d 00 00       	call   3941 <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 c6 2c 00 00       	call   3941 <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 b8 2c 00 00       	call   3949 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 b0 2c 00 00       	call   3949 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 a8 2c 00 00       	call   3949 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 6d 2c 00 00       	call   3921 <wait>
  wait();
     cb4:	e8 68 2c 00 00       	call   3921 <wait>
  wait();
     cb9:	e8 63 2c 00 00       	call   3921 <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 fa 2b 00 00       	call   3921 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 dc 2b 00 00       	call   3911 <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 8a 2b 00 00       	call   3919 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 ee 2b 00 00       	call   3999 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 5f 2b 00 00       	call   3911 <fork>
    ...
    exit();
     e1f:	e8 f5 2a 00 00       	call   3919 <exit>
     ...
     e3a:	e8 0a 2b 00 00       	call   3949 <kill>
      exit();
     e3f:	e8 d5 2a 00 00       	call   3919 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 ce 2a 00 00       	jmp    3921 <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 e8 2a 00 00       	call   3969 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 e3 41 00 00       	push   $0x41e3
     e8d:	e8 c7 2a 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 65 2a 00 00       	call   3911 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 58 2a 00 00       	call   3939 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 16 2a 00 00       	call   3921 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 28 2a 00 00       	call   3941 <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 e3 41 00 00       	push   $0x41e3
     f22:	e8 32 2a 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 e0 29 00 00       	call   3931 <read>
  ...
  close(fd);
     ...
     f86:	e8 b6 29 00 00       	call   3941 <close>
  unlink("sharedfd");
     f8b:	c7 04 24 e3 41 00 00 	movl   $0x41e3,(%esp)
     f92:	e8 d2 29 00 00       	call   3969 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 19 29 00 00       	call   3919 <exit>
    ...
    exit();
    100e:	e8 06 29 00 00       	call   3919 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 05 29 00 00       	call   3969 <unlink>
    pid = fork();
    1064:	e8 a8 28 00 00       	call   3911 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 94 28 00 00       	call   3921 <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 8d 28 00 00       	call   3921 <wait>
    1094:	e8 88 28 00 00       	call   3921 <wait>
    1099:	e8 83 28 00 00       	call   3921 <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 a7 28 00 00       	call   3959 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 5c 28 00 00       	call   3931 <read>
    ...
    10e3:	0f be 88 40 86 00 00 	movsbl 0x8640(%eax),%ecx
    ...
    1104:	e8 38 28 00 00       	call   3941 <close>
    if(total != 12*500){
    ...
    111e:	e8 46 28 00 00       	call   3969 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 22 29 00 00       	call   3a80 <printf>
          exit();
    115e:	e8 b6 27 00 00       	call   3919 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 e8 27 00 00       	call   3959 <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 8e 27 00 00       	call   3939 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 5a 27 00 00       	call   3919 <exit>
    ...
    11c8:	e8 b3 28 00 00       	call   3a80 <printf>
        exit();
    11cd:	e8 47 27 00 00       	call   3919 <exit>
    ...
    11e2:	e8 99 28 00 00       	call   3a80 <printf>
      exit();
    11e7:	e8 2d 27 00 00       	call   3919 <exit>
    ...
    11f5:	e8 86 28 00 00       	call   3a80 <printf>
      exit();
    11fa:	e8 1a 27 00 00       	call   3919 <exit>
    ...
    1208:	e8 73 28 00 00       	call   3a80 <printf>
          exit();
    120d:	e8 07 27 00 00       	call   3919 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 d2 26 00 00       	call   3911 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 c7 26 00 00       	call   3921 <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 bd 26 00 00       	call   3921 <wait>
    1264:	e8 b8 26 00 00       	call   3921 <wait>
    1269:	e8 b3 26 00 00       	call   3921 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 ab 26 00 00       	call   3959 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 6f 26 00 00       	call   3941 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 59 26 00 00       	call   3969 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 2e 27 00 00       	call   3a80 <printf>
        exit();
    1352:	e8 c2 25 00 00       	call   3919 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 ba 25 00 00       	call   3959 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 92 25 00 00       	call   3941 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 9b 25 00 00       	call   3969 <unlink>
    ...
    13de:	e8 9d 26 00 00       	call   3a80 <printf>
            exit();
    13e3:	e8 31 25 00 00       	call   3919 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 24 25 00 00       	call   3919 <exit>
    ...
    1400:	e8 7b 26 00 00       	call   3a80 <printf>
        exit();
    1405:	e8 0f 25 00 00       	call   3919 <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 67 26 00 00       	call   3a80 <printf>
      exit();
    1419:	e8 fb 24 00 00       	call   3919 <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 53 26 00 00       	call   3a80 <printf>
          exit();
    142d:	e8 e7 24 00 00       	call   3919 <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 f4 24 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 b7 24 00 00       	call   3939 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 b7 24 00 00       	call   3941 <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 95 42 00 00       	push   $0x4295
    1493:	e8 c1 24 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 b7 24 00 00       	call   3969 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 8a 24 00 00       	call   3959 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 18 24 00 00       	call   3939 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 0f 24 00 00       	call   3941 <close>
  unlink("unlinkread");
    1532:	c7 04 24 95 42 00 00 	movl   $0x4295,(%esp)
    1539:	e8 2b 24 00 00       	call   3969 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 b0 23 00 00       	call   3919 <exit>
    ...
    exit();
    1577:	e8 9d 23 00 00       	call   3919 <exit>
    ...
    exit();
    158a:	e8 8a 23 00 00       	call   3919 <exit>
    ...
    exit();
    159d:	e8 77 23 00 00       	call   3919 <exit>
    ...
    exit();
    15b0:	e8 64 23 00 00       	call   3919 <exit>
    ...
    exit();
    15c3:	e8 51 23 00 00       	call   3919 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 10 23 00 00       	call   3939 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 03 23 00 00       	call   3941 <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 5a 43 00 00       	push   $0x435a
    1645:	68 56 43 00 00       	push   $0x4356
    164a:	e8 2a 23 00 00       	call   3979 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 02 23 00 00       	call   3969 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 56 43 00 00       	push   $0x4356
    1670:	e8 e4 22 00 00       	call   3959 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 ca 22 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 82 22 00 00       	call   3931 <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 7d 22 00 00       	call   3941 <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 5a 43 00 00       	push   $0x435a
    16cb:	68 5a 43 00 00       	push   $0x435a
    16d0:	e8 a4 22 00 00       	call   3979 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 7c 22 00 00       	call   3969 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 56 43 00 00       	push   $0x4356
    16f4:	68 5a 43 00 00       	push   $0x435a
    16f9:	e8 7b 22 00 00       	call   3979 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 62 22 00 00       	call   3979 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 d1 21 00 00       	call   3919 <exit>
    ...
    exit();
    1756:	e8 be 21 00 00       	call   3919 <exit>
    ...
    exit();
    1769:	e8 ab 21 00 00       	call   3919 <exit>
    ...
    exit();
    177c:	e8 98 21 00 00       	call   3919 <exit>
    ...
    exit();
    178f:	e8 85 21 00 00       	call   3919 <exit>
    ...
    exit();
    17a2:	e8 72 21 00 00       	call   3919 <exit>
    ...
    exit();
    17b5:	e8 5f 21 00 00       	call   3919 <exit>
    ...
    exit();
    17c8:	e8 4c 21 00 00       	call   3919 <exit>
    ...
    exit();
    17db:	e8 39 21 00 00       	call   3919 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 2a 21 00 00       	call   3959 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 ff 20 00 00       	call   3941 <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 d7 20 00 00       	call   3921 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 07 21 00 00       	call   3969 <unlink>
    pid = fork();
    1862:	e8 aa 20 00 00       	call   3911 <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 cf 20 00 00       	call   3959 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 98 20 00 00       	call   3979 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 38 20 00 00       	call   3921 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 46 20 00 00       	call   3959 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 05 20 00 00       	call   3931 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 c8 1f 00 00       	call   3941 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 c7 1f 00 00       	call   3969 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 bf 1f 00 00       	call   3969 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 b7 1f 00 00       	call   3969 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 af 1f 00 00       	call   3969 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 57 1f 00 00       	call   3921 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 30 1f 00 00       	call   3911 <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 49 1f 00 00       	call   3959 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 29 1f 00 00       	call   3941 <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 37 1f 00 00       	call   3959 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 17 1f 00 00       	call   3941 <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 25 1f 00 00       	call   3959 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 05 1f 00 00       	call   3941 <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 13 1f 00 00       	call   3959 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 f3 1e 00 00       	call   3941 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 fa 1f 00 00       	call   3a80 <printf>
      exit();
    1a86:	e8 8e 1e 00 00       	call   3919 <exit>
    ...
    exit();
    1a99:	e8 7b 1e 00 00       	call   3919 <exit>
    ...
    1aac:	e8 cf 1f 00 00       	call   3a80 <printf>
        exit();
    1ab1:	e8 63 1e 00 00       	call   3919 <exit>
    ...
    1ac4:	e8 b7 1f 00 00       	call   3a80 <printf>
        exit();
    1ac9:	e8 4b 1e 00 00       	call   3919 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 6a 1e 00 00       	call   3941 <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 68 1e 00 00       	call   3969 <unlink>
  pid = fork();
    1b01:	e8 0b 1e 00 00       	call   3911 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 27 1e 00 00       	call   3969 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 de 1d 00 00       	call   3959 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 be 1d 00 00       	call   3941 <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 8a 1d 00 00       	call   3921 <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 b7 1d 00 00       	call   3979 <link>
    ...
    exit();
    1bd8:	e8 3c 1d 00 00       	call   3919 <exit>
    exit();
    1bdd:	e8 37 1d 00 00       	call   3919 <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 58 1d 00 00       	call   3969 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 a5 44 00 00       	push   $0x44a5
    1c1d:	e8 37 1d 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 06 1d 00 00       	call   3941 <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 0d 1d 00 00       	call   3979 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 dc 1c 00 00       	call   3969 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 b2 1c 00 00       	call   3969 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 8e 1d 00 00       	call   3a80 <printf>
      exit();
    1cf2:	e8 22 1c 00 00       	call   3919 <exit>
    ...
    1d01:	e8 7a 1d 00 00       	call   3a80 <printf>
      exit();
    1d06:	e8 0e 1c 00 00       	call   3919 <exit>
    ...
    exit();
    1d19:	e8 fb 1b 00 00       	call   3919 <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 2a 1c 00 00       	call   3969 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 18 46 00 00 	movl   $0x4618,(%esp)
    1d46:	e8 36 1c 00 00       	call   3981 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 f1 1b 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 b4 1b 00 00       	call   3939 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 b4 1b 00 00       	call   3941 <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 18 46 00 00 	movl   $0x4618,(%esp)
    1d94:	e8 d0 1b 00 00       	call   3969 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 d0 1b 00 00       	call   3981 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 8b 1b 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 4e 1b 00 00       	call   3939 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 4e 1b 00 00       	call   3941 <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 72 45 00 00       	push   $0x4572
    1dfc:	e8 58 1b 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 10 1b 00 00       	call   3931 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 fe 1a 00 00       	call   3941 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 b2 45 00 00       	push   $0x45b2
    1e4a:	68 4e 45 00 00       	push   $0x454e
    1e4f:	e8 25 1b 00 00       	call   3979 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 fd 1a 00 00       	call   3969 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 d3 1a 00 00       	call   3959 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 eb 1a 00 00       	call   3989 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 d3 1a 00 00       	call   3989 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 bb 1a 00 00       	call   3989 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 a3 1a 00 00       	call   3989 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 59 1a 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 11 1a 00 00       	call   3931 <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 0c 1a 00 00       	call   3941 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 4e 45 00 00       	push   $0x454e
    1f3e:	e8 16 1a 00 00       	call   3959 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 f9 19 00 00       	call   3959 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 dc 19 00 00       	call   3959 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 bf 19 00 00       	call   3959 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 a5 19 00 00       	call   3959 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 8b 19 00 00       	call   3959 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 8e 19 00 00       	call   3979 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 71 19 00 00       	call   3979 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 54 19 00 00       	call   3979 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 44 19 00 00       	call   3981 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 2c 19 00 00       	call   3981 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 14 19 00 00       	call   3981 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 e4 18 00 00       	call   3969 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 cc 18 00 00       	call   3969 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 d4 18 00 00       	call   3989 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 bc 18 00 00       	call   3989 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 84 18 00 00       	call   3969 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 6c 18 00 00       	call   3969 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 54 18 00 00       	call   3969 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 3c 18 00 00       	call   3969 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 24 18 00 00       	call   3969 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 9f 17 00 00       	call   3919 <exit>
    ...
    exit();
    2188:	e8 8c 17 00 00       	call   3919 <exit>
    ...
    exit();
    219b:	e8 79 17 00 00       	call   3919 <exit>
    ...
    exit();
    21ae:	e8 66 17 00 00       	call   3919 <exit>
    ...
    exit();
    21c1:	e8 53 17 00 00       	call   3919 <exit>
    ...
    exit();
    21d4:	e8 40 17 00 00       	call   3919 <exit>
    ...
    exit();
    21e7:	e8 2d 17 00 00       	call   3919 <exit>
    ...
    exit();
    21fa:	e8 1a 17 00 00       	call   3919 <exit>
    ...
    exit();
    220d:	e8 07 17 00 00       	call   3919 <exit>
    ...
    exit();
    2220:	e8 f4 16 00 00       	call   3919 <exit>
    ...
    exit();
    2233:	e8 e1 16 00 00       	call   3919 <exit>
    ...
    exit();
    2246:	e8 ce 16 00 00       	call   3919 <exit>
    ...
    exit();
    2259:	e8 bb 16 00 00       	call   3919 <exit>
    ...
    exit();
    226c:	e8 a8 16 00 00       	call   3919 <exit>
    ...
    exit();
    227f:	e8 95 16 00 00       	call   3919 <exit>
    ...
    exit();
    2292:	e8 82 16 00 00       	call   3919 <exit>
    ...
    exit();
    22a5:	e8 6f 16 00 00       	call   3919 <exit>
    ...
    exit();
    22b8:	e8 5c 16 00 00       	call   3919 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 49 16 00 00       	call   3919 <exit>
    ...
    exit();
    22de:	e8 36 16 00 00       	call   3919 <exit>
    ...
    exit();
    22f1:	e8 23 16 00 00       	call   3919 <exit>
    ...
    exit();
    2304:	e8 10 16 00 00       	call   3919 <exit>
    ...
    exit();
    2317:	e8 fd 15 00 00       	call   3919 <exit>
    ...
    exit();
    232a:	e8 ea 15 00 00       	call   3919 <exit>
    ...
    exit();
    233d:	e8 d7 15 00 00       	call   3919 <exit>
    ...
    exit();
    2350:	e8 c4 15 00 00       	call   3919 <exit>
    ...
    exit();
    2363:	e8 b1 15 00 00       	call   3919 <exit>
    ...
    exit();
    2376:	e8 9e 15 00 00       	call   3919 <exit>
    ...
    exit();
    2389:	e8 8b 15 00 00       	call   3919 <exit>
    ...
    exit();
    239c:	e8 78 15 00 00       	call   3919 <exit>
    ...
    exit();
    23af:	e8 65 15 00 00       	call   3919 <exit>
    ...
    exit();
    23c2:	e8 52 15 00 00       	call   3919 <exit>
    ...
    exit();
    23d5:	e8 3f 15 00 00       	call   3919 <exit>
    ...
    exit();
    23e8:	e8 2c 15 00 00       	call   3919 <exit>
    ...
    exit();
    23fb:	e8 19 15 00 00       	call   3919 <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 44 15 00 00       	call   3969 <unlink>
    ...
    243d:	e8 17 15 00 00       	call   3959 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 df 14 00 00       	call   3939 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 c9 14 00 00       	call   3939 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 bb 14 00 00       	call   3941 <close>
    unlink("bigwrite");
    2486:	c7 04 24 14 48 00 00 	movl   $0x4814,(%esp)
    248d:	e8 d7 14 00 00       	call   3969 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 bc 15 00 00       	call   3a80 <printf>
        exit();
    24c4:	e8 50 14 00 00       	call   3919 <exit>
    ...
    24d3:	e8 a8 15 00 00       	call   3a80 <printf>
      exit();
    24d8:	e8 3c 14 00 00       	call   3919 <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 68 14 00 00       	call   3969 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 70 48 00 00       	push   $0x4870
    250d:	e8 47 14 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 eb 13 00 00       	call   3939 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 d4 13 00 00       	call   3941 <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 70 48 00 00       	push   $0x4870
    2576:	e8 de 13 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 60 13 00 00       	call   3931 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 5e 13 00 00       	call   3941 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 6a 13 00 00       	call   3969 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 59 14 00 00       	call   3a80 <printf>
      exit();
    2627:	e8 ed 12 00 00       	call   3919 <exit>
    ...
    2636:	e8 45 14 00 00       	call   3a80 <printf>
      exit();
    263b:	e8 d9 12 00 00       	call   3919 <exit>
    ...
    264a:	e8 31 14 00 00       	call   3a80 <printf>
      exit();
    264f:	e8 c5 12 00 00       	call   3919 <exit>
    ...
    265e:	e8 1d 14 00 00       	call   3a80 <printf>
      exit();
    2663:	e8 b1 12 00 00       	call   3919 <exit>
    ...
    exit();
    2676:	e8 9e 12 00 00       	call   3919 <exit>
    ...
    exit();
    2689:	e8 8b 12 00 00       	call   3919 <exit>
    ...
    exit();
    269c:	e8 78 12 00 00       	call   3919 <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 b3 12 00 00       	call   3981 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 9b 12 00 00       	call   3981 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 56 12 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 2a 12 00 00       	call   3941 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 c8 51 00 00       	push   $0x51c8
    2720:	e8 34 12 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 0c 12 00 00       	call   3941 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 3c 49 00 00 	movl   $0x493c,(%esp)
    273c:	e8 40 12 00 00       	call   3981 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 2c 12 00 00       	call   3981 <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 96 11 00 00       	call   3919 <exit>
    ...
    exit();
    2791:	e8 83 11 00 00       	call   3919 <exit>
    ...
    exit();
    27a4:	e8 70 11 00 00       	call   3919 <exit>
    ...
    exit();
    27b7:	e8 5d 11 00 00       	call   3919 <exit>
    ...
    exit();
    27ca:	e8 4a 11 00 00       	call   3919 <exit>
    ...
    exit();
    27dd:	e8 37 11 00 00       	call   3919 <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 73 11 00 00       	call   3981 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 63 11 00 00       	call   3989 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 2b 11 00 00       	call   3969 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 13 11 00 00       	call   3969 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 1b 11 00 00       	call   3989 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 e3 10 00 00       	call   3969 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 cf 10 00 00       	call   3969 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 bb 10 00 00       	call   3969 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 3d 10 00 00       	call   3919 <exit>
    ...
    exit();
    28ea:	e8 2a 10 00 00       	call   3919 <exit>
    ...
    exit();
    28fd:	e8 17 10 00 00       	call   3919 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 04 10 00 00       	call   3919 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 f1 0f 00 00       	call   3919 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 de 0f 00 00       	call   3919 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 cb 0f 00 00       	call   3919 <exit>
    ...
    exit();
    295c:	e8 b8 0f 00 00       	call   3919 <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 c5 0f 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 99 0f 00 00       	call   3941 <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 25 4a 00 00 	movl   $0x4a25,(%esp)
    29af:	e8 d5 0f 00 00       	call   3989 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 8b 0f 00 00       	call   3959 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 6e 0f 00 00       	call   3959 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 7e 0f 00 00       	call   3981 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 4e 0f 00 00       	call   3969 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 41 0f 00 00       	call   3979 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 19 0f 00 00       	call   3969 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 ef 0e 00 00       	call   3959 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 d5 0e 00 00       	call   3959 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 a3 0e 00 00       	call   3939 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 9b 0e 00 00       	call   3941 <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 4a 0e 00 00       	call   3919 <exit>
    ...
    exit();
    2add:	e8 37 0e 00 00       	call   3919 <exit>
    ...
    exit();
    2af0:	e8 24 0e 00 00       	call   3919 <exit>
    ...
    exit();
    2b03:	e8 11 0e 00 00       	call   3919 <exit>
    ...
    exit();
    2b16:	e8 fe 0d 00 00       	call   3919 <exit>
    ...
    exit();
    2b29:	e8 eb 0d 00 00       	call   3919 <exit>
    ...
    exit();
    2b3c:	e8 d8 0d 00 00       	call   3919 <exit>
    ...
    exit();
    2b4f:	e8 c5 0d 00 00       	call   3919 <exit>
    ...
    exit();
    2b62:	e8 b2 0d 00 00       	call   3919 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 e4 0d 00 00       	call   3981 <mkdir>
    ...
    2bb0:	e8 d4 0d 00 00       	call   3989 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 1d 0d 00 00       	call   3941 <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 00 47 00 00       	push   $0x4700
    2c2f:	e8 35 0d 00 00       	call   3969 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 3c 0d 00 00       	call   3989 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 0e 0e 00 00       	call   3a80 <printf>
      exit();
    2c72:	e8 a2 0c 00 00       	call   3919 <exit>
    ...
    2c81:	e8 fa 0d 00 00       	call   3a80 <printf>
      exit();
    2c86:	e8 8e 0c 00 00       	call   3919 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 4f 0c 00 00       	call   3911 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 4c 0c 00 00       	call   3921 <wait>
  ...
  if(wait() != -1){
    2cde:	e8 3e 0c 00 00       	call   3921 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 18 0c 00 00       	call   3919 <exit>
    ...
    2d0b:	e8 70 0d 00 00       	call   3a80 <printf>
      exit();
    2d10:	e8 04 0c 00 00       	call   3919 <exit>
    ...
    exit();
    2d23:	e8 f1 0b 00 00       	call   3919 <exit>
    ...
    exit();
    2d36:	e8 de 0b 00 00       	call   3919 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 15 0c 00 00       	call   39a1 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 64 0b 00 00       	call   3911 <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 dd 0b 00 00       	call   39a1 <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 d1 0b 00 00       	call   39a1 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 39 0b 00 00       	call   3921 <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 af 0b 00 00       	call   39a1 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 9e 0b 00 00       	call   39a1 <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 89 0b 00 00       	call   39a1 <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 7b 0b 00 00       	call   39a1 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 65 0b 00 00       	call   39a1 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 4a 0b 00 00       	call   39a1 <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 3c 0b 00 00       	call   39a1 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 25 0b 00 00       	call   39a1 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 bc 0a 00 00       	call   3999 <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 2d 0a 00 00       	call   3911 <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 2a 0a 00 00       	call   3921 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 18 0a 00 00       	call   3929 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 e4 09 00 00       	call   3911 <fork>
    ...
    2f48:	e8 e4 09 00 00       	call   3931 <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 3d 0a 00 00       	call   39a1 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 c9 09 00 00       	call   3949 <kill>
    wait();
    2f80:	e8 9c 09 00 00       	call   3921 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 ff 09 00 00       	call   39a1 <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fb2:	ff 35 fc 5e 00 00    	push   0x5efc
    ...
    exit();
    310c:	e8 08 08 00 00       	call   3919 <exit>
    exit();
    3111:	e8 03 08 00 00       	call   3919 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 d5 4b 00 00       	push   $0x4bd5
    311d:	ff 35 fc 5e 00 00    	push   0x5efc
    3123:	e8 58 09 00 00       	call   3a80 <printf>
    exit();
    3128:	e8 ec 07 00 00       	call   3919 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 94 53 00 00       	push   $0x5394
    3134:	ff 35 fc 5e 00 00    	push   0x5efc
    313a:	e8 41 09 00 00       	call   3a80 <printf>
    exit();
    313f:	e8 d5 07 00 00       	call   3919 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 5c 53 00 00       	push   $0x535c
    314b:	ff 35 fc 5e 00 00    	push   0x5efc
    3151:	e8 2a 09 00 00       	call   3a80 <printf>
    exit();
    3156:	e8 be 07 00 00       	call   3919 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 f1 4b 00 00       	push   $0x4bf1
    3162:	ff 35 fc 5e 00 00    	push   0x5efc
    3168:	e8 13 09 00 00       	call   3a80 <printf>
    exit();
    316d:	e8 a7 07 00 00       	call   3919 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 e4 07 00 00       	call   39a9 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 d8 07 00 00       	call   39a9 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 70 07 00 00       	call   3949 <kill>
    wait();
    31d9:	e8 43 07 00 00       	call   3921 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 5d 4c 00 00       	push   $0x4c5d
    31e6:	e8 8e 07 00 00       	call   3979 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 fc 5e 00 00    	push   0x5efc
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 f6 06 00 00       	call   3919 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 68 4c 00 00       	push   $0x4c68
    322b:	ff 35 fc 5e 00 00    	push   0x5efc
    3231:	e8 4a 08 00 00       	call   3a80 <printf>
      exit();
    3236:	e8 de 06 00 00       	call   3919 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 fc 5e 00 00    	push   0x5efc
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    325f:	90                   	nop
    if(uninit[i] != '\0'){
    3260:	80 b8 20 5f 00 00 00 	cmpb   $0x0,0x5f20(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 fc 5e 00 00    	push   0x5efc
    ...
    3293:	ff 35 fc 5e 00 00    	push   0x5efc
    3299:	e8 e2 07 00 00       	call   3a80 <printf>
      exit();
    329e:	e8 76 06 00 00       	call   3919 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 a9 06 00 00       	call   3969 <unlink>
  pid = fork();
    32c0:	e8 4c 06 00 00       	call   3911 <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 4a 06 00 00       	call   3921 <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 b6 4c 00 00       	push   $0x4cb6
    32e1:	e8 73 06 00 00       	call   3959 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 47 06 00 00       	call   3941 <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 b6 4c 00 00 	movl   $0x4cb6,(%esp)
    3301:	e8 63 06 00 00       	call   3969 <unlink>
}
    ...
    3310:	c7 04 85 40 a6 00 00 	movl   $0x5410,0xa640(,%eax,4)
    3317:	10 54 00 00 
    ...
    332a:	ff 35 fc 5e 00 00    	push   0x5efc
    args[MAXARG-1] = 0;
    3330:	c7 05 bc a6 00 00 00 	movl   $0x0,0xa6bc
    3337:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    333f:	58                   	pop    %eax
    3340:	5a                   	pop    %edx
    3341:	68 40 a6 00 00       	push   $0xa640
    3346:	68 8d 3e 00 00       	push   $0x3e8d
    334b:	e8 01 06 00 00       	call   3951 <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 cd 4c 00 00       	push   $0x4ccd
    3357:	ff 35 fc 5e 00 00    	push   0x5efc
    ...
    336e:	e8 e6 05 00 00       	call   3959 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 c6 05 00 00       	call   3941 <close>
    exit();
    337b:	e8 99 05 00 00       	call   3919 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 f6 4c 00 00       	push   $0x4cf6
    3387:	ff 35 fc 5e 00 00    	push   0x5efc
    338d:	e8 ee 06 00 00       	call   3a80 <printf>
    exit();
    3392:	e8 82 05 00 00       	call   3919 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 dd 4c 00 00       	push   $0x4cdd
    339e:	ff 35 fc 5e 00 00    	push   0x5efc
    33a4:	e8 d7 06 00 00       	call   3a80 <printf>
    exit();
    33a9:	e8 6b 05 00 00       	call   3919 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 fb 04 00 00       	call   3959 <open>
    if(fd < 0){
    ...
    347a:	68 40 86 00 00       	push   $0x8640
    347f:	57                   	push   %edi
    3480:	e8 b4 04 00 00       	call   3939 <write>
      if(cc < 512)
    ...
    34a2:	e8 9a 04 00 00       	call   3941 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 18 04 00 00       	call   3969 <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 7a 03 00 00       	call   3911 <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 7c 03 00 00       	call   3921 <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 3c 03 00 00       	call   3919 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 29 03 00 00       	call   3919 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 56 03 00 00       	call   3959 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 8b 03 00 00       	call   39a1 <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 0c 03 00 00       	call   3931 <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 14 03 00 00       	call   3941 <close>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 74 01 00 00       	call   3931 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 37 01 00 00       	call   3959 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 3a 01 00 00       	call   3971 <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 00 01 00 00       	call   3941 <close>
  return r;
...
thread_join()
{
  return 0; 
    ...
    38e2:	c3                   	ret    
    38e3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
SYSCALL(fork)
    3911:	b8 01 00 00 00       	mov    $0x1,%eax
    3916:	cd 40                	int    $0x40
    3918:	c3                   	ret    

00003919 <exit>:
SYSCALL(exit)
    3919:	b8 02 00 00 00       	mov    $0x2,%eax
    391e:	cd 40                	int    $0x40
    3920:	c3                   	ret    

00003921 <wait>:
SYSCALL(wait)
    3921:	b8 03 00 00 00       	mov    $0x3,%eax
    3926:	cd 40                	int    $0x40
    3928:	c3                   	ret    

00003929 <pipe>:
SYSCALL(pipe)
    3929:	b8 04 00 00 00       	mov    $0x4,%eax
    392e:	cd 40                	int    $0x40
    3930:	c3                   	ret    

00003931 <read>:
SYSCALL(read)
    3931:	b8 05 00 00 00       	mov    $0x5,%eax
    3936:	cd 40                	int    $0x40
    3938:	c3                   	ret    

00003939 <write>:
SYSCALL(write)
    3939:	b8 10 00 00 00       	mov    $0x10,%eax
    393e:	cd 40                	int    $0x40
    3940:	c3                   	ret    

00003941 <close>:
SYSCALL(close)
    3941:	b8 15 00 00 00       	mov    $0x15,%eax
    3946:	cd 40                	int    $0x40
    3948:	c3                   	ret    

00003949 <kill>:
SYSCALL(kill)
    3949:	b8 06 00 00 00       	mov    $0x6,%eax
    394e:	cd 40                	int    $0x40
    3950:	c3                   	ret    

00003951 <exec>:
SYSCALL(exec)
    3951:	b8 07 00 00 00       	mov    $0x7,%eax
    3956:	cd 40                	int    $0x40
    3958:	c3                   	ret    

00003959 <open>:
SYSCALL(open)
    3959:	b8 0f 00 00 00       	mov    $0xf,%eax
    395e:	cd 40                	int    $0x40
    3960:	c3                   	ret    

00003961 <mknod>:
SYSCALL(mknod)
    3961:	b8 11 00 00 00       	mov    $0x11,%eax
    3966:	cd 40                	int    $0x40
    3968:	c3                   	ret    

00003969 <unlink>:
SYSCALL(unlink)
    3969:	b8 12 00 00 00       	mov    $0x12,%eax
    396e:	cd 40                	int    $0x40
    3970:	c3                   	ret    

00003971 <fstat>:
SYSCALL(fstat)
    3971:	b8 08 00 00 00       	mov    $0x8,%eax
    3976:	cd 40                	int    $0x40
    3978:	c3                   	ret    

00003979 <link>:
SYSCALL(link)
    3979:	b8 13 00 00 00       	mov    $0x13,%eax
    397e:	cd 40                	int    $0x40
    3980:	c3                   	ret    

00003981 <mkdir>:
SYSCALL(mkdir)
    3981:	b8 14 00 00 00       	mov    $0x14,%eax
    3986:	cd 40                	int    $0x40
    3988:	c3                   	ret    

00003989 <chdir>:
SYSCALL(chdir)
    3989:	b8 09 00 00 00       	mov    $0x9,%eax
    398e:	cd 40                	int    $0x40
    3990:	c3                   	ret    

00003991 <dup>:
SYSCALL(dup)
    3991:	b8 0a 00 00 00       	mov    $0xa,%eax
    3996:	cd 40                	int    $0x40
    3998:	c3                   	ret    

00003999 <getpid>:
SYSCALL(getpid)
    3999:	b8 0b 00 00 00       	mov    $0xb,%eax
    399e:	cd 40                	int    $0x40
    39a0:	c3                   	ret    

000039a1 <sbrk>:
SYSCALL(sbrk)
    39a1:	b8 0c 00 00 00       	mov    $0xc,%eax
    39a6:	cd 40                	int    $0x40
    39a8:	c3                   	ret    

000039a9 <sleep>:
SYSCALL(sleep)
    39a9:	b8 0d 00 00 00       	mov    $0xd,%eax
    39ae:	cd 40                	int    $0x40
    39b0:	c3                   	ret    

000039b1 <uptime>:
SYSCALL(uptime)
    39b1:	b8 0e 00 00 00       	mov    $0xe,%eax
    39b6:	cd 40                	int    $0x40
    39b8:	c3                   	ret    

000039b9 <join>:
SYSCALL(join)
    39b9:	b8 16 00 00 00       	mov    $0x16,%eax
    39be:	cd 40                	int    $0x40
    39c0:	c3                   	ret    

000039c1 <clone>:
SYSCALL(clone)
    39c1:	b8 17 00 00 00       	mov    $0x17,%eax
    39c6:	cd 40                	int    $0x40
    39c8:	c3                   	ret    
    ...
    39dc:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a4e:	56                   	push   %esi
    3a4f:	57                   	push   %edi
    3a50:	e8 e4 fe ff ff       	call   3939 <write>
  while(--i >= 0)
    ...
    3a89:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3ac5:	57                   	push   %edi
    3ac6:	56                   	push   %esi
    3ac7:	e8 6d fe ff ff       	call   3939 <write>
  ...
  write(fd, &c, 1);
    ...
    3b1e:	e8 16 fe ff ff       	call   3939 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b2f:	57                   	push   %edi
    3b30:	56                   	push   %esi
    3b31:	e8 03 fe ff ff       	call   3939 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b9b:	57                   	push   %edi
    3b9c:	56                   	push   %esi
    3b9d:	e8 97 fd ff ff       	call   3939 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3bdf:	e8 55 fd ff ff       	call   3939 <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c21:	a1 c0 a6 00 00       	mov    0xa6c0,%eax
{
  ...
  freep = p;
    ...
    3c61:	5b                   	pop    %ebx
  freep = p;
    3c62:	89 15 c0 a6 00 00    	mov    %edx,0xa6c0
}
    3c68:	5e                   	pop    %esi
    3c69:	5f                   	pop    %edi
    3c6a:	5d                   	pop    %ebp
  ...
  freep = p;
    3c9c:	89 15 c0 a6 00 00    	mov    %edx,0xa6c0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cbc:	8b 3d c0 a6 00 00    	mov    0xa6c0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3d01:	8b 3d c0 a6 00 00    	mov    0xa6c0,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d13:	e8 89 fc ff ff       	call   39a1 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3d2f:	8b 15 c0 a6 00 00    	mov    0xa6c0,%edx
    ...
    3d5c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3d5f:	89 15 c0 a6 00 00    	mov    %edx,0xa6c0
}
    ...
    3d6f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3d70:	c7 05 c0 a6 00 00 c4 	movl   $0xa6c4,0xa6c0
    3d77:	a6 00 00 
    base.s.size = 0;
    3d7a:	bf c4 a6 00 00       	mov    $0xa6c4,%edi
    base.s.ptr = freep = prevp = &base;
    3d7f:	c7 05 c4 a6 00 00 c4 	movl   $0xa6c4,0xa6c4
    3d86:	a6 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d89:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3d8b:	c7 05 c8 a6 00 00 00 	movl   $0x0,0xa6c8
    3d92:	00 00 00 
    if(p->s.size >= nunits){
