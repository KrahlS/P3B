...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 79 0e 00 00       	call   ea9 <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 0c 0e 00 00       	call   e61 <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 0a 0e 00 00       	call   e71 <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 d6 0d 00 00       	call   e91 <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 e4 0d 00 00       	call   ed9 <chdir>
  ...
  exit();
     11a:	e8 4a 0d 00 00       	call   e69 <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 df 0c 00 00       	call   e69 <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 c6 0c 00 00       	call   e61 <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 be 0c 00 00       	call   ea1 <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 64 0c 00 00       	call   e69 <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 5a 0c 00 00       	call   e79 <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 42 0c 00 00       	call   e91 <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 39 0c 00 00       	call   e91 <close>
    wait();
     258:	e8 14 0c 00 00       	call   e71 <wait>
    wait();
     25d:	e8 0f 0c 00 00       	call   e71 <wait>
    break;
    ...
    wait();
     270:	e8 fc 0b 00 00       	call   e71 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 06 0c 00 00       	call   e91 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 11 0c 00 00       	call   ea9 <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 09 0d 00 00       	call   fd0 <printf>
      exit();
     2c7:	e8 9d 0b 00 00       	call   e69 <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 ae 0b 00 00       	call   e91 <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 f5 0b 00 00       	call   ee1 <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 9c 0b 00 00       	call   e91 <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 93 0b 00 00       	call   e91 <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 80 0b 00 00       	call   e91 <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 c7 0b 00 00       	call   ee1 <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 6e 0b 00 00       	call   e91 <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 65 0b 00 00       	call   e91 <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 74 01 00 00       	call   e81 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 37 01 00 00       	call   ea9 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 3a 01 00 00       	call   ec1 <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 00 01 00 00       	call   e91 <close>
  return r;
...
thread_join()
{
  return 0; 
     ...
     e32:	c3                   	ret    
     e33:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
SYSCALL(fork)
     e61:	b8 01 00 00 00       	mov    $0x1,%eax
     e66:	cd 40                	int    $0x40
     e68:	c3                   	ret    

00000e69 <exit>:
SYSCALL(exit)
     e69:	b8 02 00 00 00       	mov    $0x2,%eax
     e6e:	cd 40                	int    $0x40
     e70:	c3                   	ret    

00000e71 <wait>:
SYSCALL(wait)
     e71:	b8 03 00 00 00       	mov    $0x3,%eax
     e76:	cd 40                	int    $0x40
     e78:	c3                   	ret    

00000e79 <pipe>:
SYSCALL(pipe)
     e79:	b8 04 00 00 00       	mov    $0x4,%eax
     e7e:	cd 40                	int    $0x40
     e80:	c3                   	ret    

00000e81 <read>:
SYSCALL(read)
     e81:	b8 05 00 00 00       	mov    $0x5,%eax
     e86:	cd 40                	int    $0x40
     e88:	c3                   	ret    

00000e89 <write>:
SYSCALL(write)
     e89:	b8 10 00 00 00       	mov    $0x10,%eax
     e8e:	cd 40                	int    $0x40
     e90:	c3                   	ret    

00000e91 <close>:
SYSCALL(close)
     e91:	b8 15 00 00 00       	mov    $0x15,%eax
     e96:	cd 40                	int    $0x40
     e98:	c3                   	ret    

00000e99 <kill>:
SYSCALL(kill)
     e99:	b8 06 00 00 00       	mov    $0x6,%eax
     e9e:	cd 40                	int    $0x40
     ea0:	c3                   	ret    

00000ea1 <exec>:
SYSCALL(exec)
     ea1:	b8 07 00 00 00       	mov    $0x7,%eax
     ea6:	cd 40                	int    $0x40
     ea8:	c3                   	ret    

00000ea9 <open>:
SYSCALL(open)
     ea9:	b8 0f 00 00 00       	mov    $0xf,%eax
     eae:	cd 40                	int    $0x40
     eb0:	c3                   	ret    

00000eb1 <mknod>:
SYSCALL(mknod)
     eb1:	b8 11 00 00 00       	mov    $0x11,%eax
     eb6:	cd 40                	int    $0x40
     eb8:	c3                   	ret    

00000eb9 <unlink>:
SYSCALL(unlink)
     eb9:	b8 12 00 00 00       	mov    $0x12,%eax
     ebe:	cd 40                	int    $0x40
     ec0:	c3                   	ret    

00000ec1 <fstat>:
SYSCALL(fstat)
     ec1:	b8 08 00 00 00       	mov    $0x8,%eax
     ec6:	cd 40                	int    $0x40
     ec8:	c3                   	ret    

00000ec9 <link>:
SYSCALL(link)
     ec9:	b8 13 00 00 00       	mov    $0x13,%eax
     ece:	cd 40                	int    $0x40
     ed0:	c3                   	ret    

00000ed1 <mkdir>:
SYSCALL(mkdir)
     ed1:	b8 14 00 00 00       	mov    $0x14,%eax
     ed6:	cd 40                	int    $0x40
     ed8:	c3                   	ret    

00000ed9 <chdir>:
SYSCALL(chdir)
     ed9:	b8 09 00 00 00       	mov    $0x9,%eax
     ede:	cd 40                	int    $0x40
     ee0:	c3                   	ret    

00000ee1 <dup>:
SYSCALL(dup)
     ee1:	b8 0a 00 00 00       	mov    $0xa,%eax
     ee6:	cd 40                	int    $0x40
     ee8:	c3                   	ret    

00000ee9 <getpid>:
SYSCALL(getpid)
     ee9:	b8 0b 00 00 00       	mov    $0xb,%eax
     eee:	cd 40                	int    $0x40
     ef0:	c3                   	ret    

00000ef1 <sbrk>:
SYSCALL(sbrk)
     ef1:	b8 0c 00 00 00       	mov    $0xc,%eax
     ef6:	cd 40                	int    $0x40
     ef8:	c3                   	ret    

00000ef9 <sleep>:
SYSCALL(sleep)
     ef9:	b8 0d 00 00 00       	mov    $0xd,%eax
     efe:	cd 40                	int    $0x40
     f00:	c3                   	ret    

00000f01 <uptime>:
SYSCALL(uptime)
     f01:	b8 0e 00 00 00       	mov    $0xe,%eax
     f06:	cd 40                	int    $0x40
     f08:	c3                   	ret    

00000f09 <join>:
SYSCALL(join)
     f09:	b8 16 00 00 00       	mov    $0x16,%eax
     f0e:	cd 40                	int    $0x40
     f10:	c3                   	ret    

00000f11 <clone>:
SYSCALL(clone)
     f11:	b8 17 00 00 00       	mov    $0x17,%eax
     f16:	cd 40                	int    $0x40
     f18:	c3                   	ret    
     ...
     f2c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     f9e:	56                   	push   %esi
     f9f:	57                   	push   %edi
     fa0:	e8 e4 fe ff ff       	call   e89 <write>
  while(--i >= 0)
     ...
     fd9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1015:	57                   	push   %edi
    1016:	56                   	push   %esi
    1017:	e8 6d fe ff ff       	call   e89 <write>
  ...
  write(fd, &c, 1);
    ...
    106e:	e8 16 fe ff ff       	call   e89 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    107f:	57                   	push   %edi
    1080:	56                   	push   %esi
    1081:	e8 03 fe ff ff       	call   e89 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10eb:	57                   	push   %edi
    10ec:	56                   	push   %esi
    10ed:	e8 97 fd ff ff       	call   e89 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    112f:	e8 55 fd ff ff       	call   e89 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1263:	e8 89 fc ff ff       	call   ef1 <sbrk>
  if(p == (char*)-1)
