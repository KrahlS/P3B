...
main(int argc, char *argv[])
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
   ppid = getpid();
  14:	e8 b0 04 00 00       	call   4c9 <getpid>
   void *stack, *p = malloc(PGSIZE*2);
  19:	83 ec 0c             	sub    $0xc,%esp
  1c:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  21:	a3 04 0d 00 00       	mov    %eax,0xd04
   void *stack, *p = malloc(PGSIZE*2);
  26:	e8 b5 07 00 00       	call   7e0 <malloc>
   assert(p != NULL);
  2b:	83 c4 10             	add    $0x10,%esp
  2e:	85 c0                	test   %eax,%eax
  30:	0f 84 e9 00 00 00    	je     11f <main+0x11f>
   if((uint)p % PGSIZE)
  36:	89 c2                	mov    %eax,%edx
  38:	89 c3                	mov    %eax,%ebx
  3a:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
  40:	0f 85 a2 00 00 00    	jne    e8 <main+0xe8>
  ...
  47:	6a 00                	push   $0x0
  49:	6a 00                	push   $0x0
  4b:	68 40 01 00 00       	push   $0x140
  50:	e8 9c 04 00 00       	call   4f1 <clone>
   assert(clone_pid > 0);
  ...
  5c:	0f 8e a0 00 00 00    	jle    102 <main+0x102>
  62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
   while(global != 5);
  68:	a1 00 0d 00 00       	mov    0xd00,%eax
  6d:	83 f8 05             	cmp    $0x5,%eax
  70:	75 f6                	jne    68 <main+0x68>
   printf(1, "TEST PASSED\n");
  72:	50                   	push   %eax
  73:	50                   	push   %eax
  74:	68 2e 09 00 00       	push   $0x92e
  79:	6a 01                	push   $0x1
  7b:	e8 30 05 00 00       	call   5b0 <printf>
   
   void *join_stack;
   int join_pid = join(&join_stack);
  80:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  83:	89 04 24             	mov    %eax,(%esp)
  86:	e8 5e 04 00 00       	call   4e9 <join>
   printf(1, "join_pid: %d\nclone_pid: %d\n", join_pid, clone_pid); 
  8b:	56                   	push   %esi
  8c:	50                   	push   %eax
   int join_pid = join(&join_stack);
  8d:	89 c7                	mov    %eax,%edi
   printf(1, "join_pid: %d\nclone_pid: %d\n", join_pid, clone_pid); 
  8f:	68 3b 09 00 00       	push   $0x93b
  94:	6a 01                	push   $0x1
  96:	e8 15 05 00 00       	call   5b0 <printf>
   assert(join_pid == clone_pid);
  9b:	83 c4 20             	add    $0x20,%esp
  9e:	39 fe                	cmp    %edi,%esi
  a0:	74 52                	je     f4 <main+0xf4>
  a2:	6a 2a                	push   $0x2a
  a4:	68 d8 08 00 00       	push   $0x8d8
  a9:	68 e1 08 00 00       	push   $0x8e1
  ae:	6a 01                	push   $0x1
  b0:	e8 fb 04 00 00       	call   5b0 <printf>
  b5:	83 c4 0c             	add    $0xc,%esp
  b8:	68 57 09 00 00       	push   $0x957
   assert(clone_pid > 0);
  bd:	68 f5 08 00 00       	push   $0x8f5
  c2:	6a 01                	push   $0x1
  c4:	e8 e7 04 00 00       	call   5b0 <printf>
  c9:	5a                   	pop    %edx
  ca:	59                   	pop    %ecx
  cb:	68 09 09 00 00       	push   $0x909
  d0:	6a 01                	push   $0x1
  d2:	e8 d9 04 00 00       	call   5b0 <printf>
  d7:	5b                   	pop    %ebx
  d8:	ff 35 04 0d 00 00    	push   0xd04
  de:	e8 96 03 00 00       	call   479 <kill>
  e3:	e8 61 03 00 00       	call   449 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  e8:	29 d0                	sub    %edx,%eax
  ea:	05 00 10 00 00       	add    $0x1000,%eax
  ef:	e9 52 ff ff ff       	jmp    46 <main+0x46>
   free(p);
  f4:	83 ec 0c             	sub    $0xc,%esp
  f7:	53                   	push   %ebx
  f8:	e8 53 06 00 00       	call   750 <free>
   exit();
  fd:	e8 47 03 00 00       	call   449 <exit>
   assert(clone_pid > 0);
 102:	6a 23                	push   $0x23
 104:	68 d8 08 00 00       	push   $0x8d8
 109:	68 e1 08 00 00       	push   $0x8e1
 10e:	6a 01                	push   $0x1
 110:	e8 9b 04 00 00       	call   5b0 <printf>
 115:	83 c4 0c             	add    $0xc,%esp
 118:	68 20 09 00 00       	push   $0x920
 11d:	eb 9e                	jmp    bd <main+0xbd>
   assert(p != NULL);
 11f:	6a 1c                	push   $0x1c
 121:	68 d8 08 00 00       	push   $0x8d8
 126:	68 e1 08 00 00       	push   $0x8e1
 12b:	6a 01                	push   $0x1
 12d:	e8 7e 04 00 00       	call   5b0 <printf>
 132:	83 c4 0c             	add    $0xc,%esp
 135:	68 16 09 00 00       	push   $0x916
 13a:	eb 81                	jmp    bd <main+0xbd>
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 00 0d 00 00       	mov    0xd00,%eax
 14b:	83 f8 01             	cmp    $0x1,%eax
 14e:	74 46                	je     196 <worker+0x56>
 150:	6a 31                	push   $0x31
 152:	68 d8 08 00 00       	push   $0x8d8
 157:	68 e1 08 00 00       	push   $0x8e1
 15c:	6a 01                	push   $0x1
 15e:	e8 4d 04 00 00       	call   5b0 <printf>
 163:	83 c4 0c             	add    $0xc,%esp
 166:	68 e9 08 00 00       	push   $0x8e9
 16b:	68 f5 08 00 00       	push   $0x8f5
 170:	6a 01                	push   $0x1
 172:	e8 39 04 00 00       	call   5b0 <printf>
 177:	58                   	pop    %eax
 178:	5a                   	pop    %edx
 179:	68 09 09 00 00       	push   $0x909
 17e:	6a 01                	push   $0x1
 180:	e8 2b 04 00 00       	call   5b0 <printf>
 185:	59                   	pop    %ecx
 186:	ff 35 04 0d 00 00    	push   0xd04
 18c:	e8 e8 02 00 00       	call   479 <kill>
 191:	e8 b3 02 00 00       	call   449 <exit>
   global = 5;
 196:	c7 05 00 0d 00 00 05 	movl   $0x5,0xd00
 19d:	00 00 00 
   exit();
 1a0:	e8 a4 02 00 00       	call   449 <exit>
 ...
 2d9:	31 db                	xor    %ebx,%ebx
{
 ...
 2e5:	57                   	push   %edi
 2e6:	6a 00                	push   $0x0
 2e8:	e8 74 01 00 00       	call   461 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 34d:	e8 37 01 00 00       	call   489 <open>
  if(fd < 0)
 ...
 361:	50                   	push   %eax
 362:	e8 3a 01 00 00       	call   4a1 <fstat>
  close(fd);
 367:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 36a:	89 c6                	mov    %eax,%esi
  close(fd);
 36c:	e8 00 01 00 00       	call   471 <close>
  return r;
 ...
 5b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 737:	90                   	nop
          s = "(null)";
 738:	ba 6d 09 00 00       	mov    $0x96d,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 751:	a1 08 0d 00 00       	mov    0xd08,%eax
{
 ...
 791:	5b                   	pop    %ebx
  freep = p;
 792:	89 15 08 0d 00 00    	mov    %edx,0xd08
}
 798:	5e                   	pop    %esi
 799:	5f                   	pop    %edi
 79a:	5d                   	pop    %ebp
 ...
 7c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7cc:	89 15 08 0d 00 00    	mov    %edx,0xd08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ec:	8b 3d 08 0d 00 00    	mov    0xd08,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 82f:	73 4f                	jae    880 <malloc+0xa0>
    ...
    if(p == freep)
 831:	8b 3d 08 0d 00 00    	mov    0xd08,%edi
 ...
 85a:	e8 f1 fe ff ff       	call   750 <free>
  return freep;
 85f:	8b 15 08 0d 00 00    	mov    0xd08,%edx
 ...
 88c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 88f:	89 15 08 0d 00 00    	mov    %edx,0xd08
}
 ...
 89f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8a0:	c7 05 08 0d 00 00 0c 	movl   $0xd0c,0xd08
 8a7:	0d 00 00 
    base.s.size = 0;
 8aa:	bf 0c 0d 00 00       	mov    $0xd0c,%edi
    base.s.ptr = freep = prevp = &base;
 8af:	c7 05 0c 0d 00 00 0c 	movl   $0xd0c,0xd0c
 8b6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8bb:	c7 05 10 0d 00 00 00 	movl   $0x0,0xd10
 8c2:	00 00 00 
    if(p->s.size >= nunits){
