...
main(int argc, char *argv[])
{
  ...
  55:	e8 d7 05 00 00       	call   631 <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 db 05 00 00       	call   649 <open>
  ...
  81:	e8 ea 06 00 00       	call   770 <printf>
      exit();
  86:	e8 7e 05 00 00       	call   609 <exit>
  }
  exit();
  8b:	e8 79 05 00 00       	call   609 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 d2 06 00 00       	call   770 <printf>
    exit();
  9e:	e8 66 05 00 00       	call   609 <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 57 05 00 00       	call   609 <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 1fd:	50                   	push   %eax
 1fe:	8d 81 40 0f 00 00    	lea    0xf40(%ecx),%eax
 204:	50                   	push   %eax
 205:	ff 75 0c             	push   0xc(%ebp)
 208:	e8 14 04 00 00       	call   621 <read>
 ...
 21b:	8b 4d dc             	mov    -0x24(%ebp),%ecx
    p = buf;
 21e:	c7 45 e4 40 0f 00 00 	movl   $0xf40,-0x1c(%ebp)
    buf[m] = '\0';
 225:	c6 81 40 0f 00 00 00 	movb   $0x0,0xf40(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 98 03 00 00       	call   629 <write>
 ...
 2bb:	81 fa 40 0f 00 00    	cmp    $0xf40,%edx
 ...
 2d0:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2d3:	2d 40 0f 00 00       	sub    $0xf40,%eax
 2d8:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
 2da:	51                   	push   %ecx
 2db:	52                   	push   %edx
 2dc:	68 40 0f 00 00       	push   $0xf40
      m -= p - buf;
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 74 01 00 00       	call   621 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 37 01 00 00       	call   649 <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 3a 01 00 00       	call   661 <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 00 01 00 00       	call   631 <close>
  return r;
...
00000609 <exit>:
SYSCALL(exit)
 609:	b8 02 00 00 00       	mov    $0x2,%eax
 60e:	cd 40                	int    $0x40
 610:	c3                   	ret    

00000611 <wait>:
SYSCALL(wait)
 611:	b8 03 00 00 00       	mov    $0x3,%eax
 616:	cd 40                	int    $0x40
 618:	c3                   	ret    

00000619 <pipe>:
SYSCALL(pipe)
 619:	b8 04 00 00 00       	mov    $0x4,%eax
 61e:	cd 40                	int    $0x40
 620:	c3                   	ret    

00000621 <read>:
SYSCALL(read)
 621:	b8 05 00 00 00       	mov    $0x5,%eax
 626:	cd 40                	int    $0x40
 628:	c3                   	ret    

00000629 <write>:
SYSCALL(write)
 629:	b8 10 00 00 00       	mov    $0x10,%eax
 62e:	cd 40                	int    $0x40
 630:	c3                   	ret    

00000631 <close>:
SYSCALL(close)
 631:	b8 15 00 00 00       	mov    $0x15,%eax
 636:	cd 40                	int    $0x40
 638:	c3                   	ret    

00000639 <kill>:
SYSCALL(kill)
 639:	b8 06 00 00 00       	mov    $0x6,%eax
 63e:	cd 40                	int    $0x40
 640:	c3                   	ret    

00000641 <exec>:
SYSCALL(exec)
 641:	b8 07 00 00 00       	mov    $0x7,%eax
 646:	cd 40                	int    $0x40
 648:	c3                   	ret    

00000649 <open>:
SYSCALL(open)
 649:	b8 0f 00 00 00       	mov    $0xf,%eax
 64e:	cd 40                	int    $0x40
 650:	c3                   	ret    

00000651 <mknod>:
SYSCALL(mknod)
 651:	b8 11 00 00 00       	mov    $0x11,%eax
 656:	cd 40                	int    $0x40
 658:	c3                   	ret    

00000659 <unlink>:
SYSCALL(unlink)
 659:	b8 12 00 00 00       	mov    $0x12,%eax
 65e:	cd 40                	int    $0x40
 660:	c3                   	ret    

00000661 <fstat>:
SYSCALL(fstat)
 661:	b8 08 00 00 00       	mov    $0x8,%eax
 666:	cd 40                	int    $0x40
 668:	c3                   	ret    

00000669 <link>:
SYSCALL(link)
 669:	b8 13 00 00 00       	mov    $0x13,%eax
 66e:	cd 40                	int    $0x40
 670:	c3                   	ret    

00000671 <mkdir>:
SYSCALL(mkdir)
 671:	b8 14 00 00 00       	mov    $0x14,%eax
 676:	cd 40                	int    $0x40
 678:	c3                   	ret    

00000679 <chdir>:
SYSCALL(chdir)
 679:	b8 09 00 00 00       	mov    $0x9,%eax
 67e:	cd 40                	int    $0x40
 680:	c3                   	ret    

00000681 <dup>:
SYSCALL(dup)
 681:	b8 0a 00 00 00       	mov    $0xa,%eax
 686:	cd 40                	int    $0x40
 688:	c3                   	ret    

00000689 <getpid>:
SYSCALL(getpid)
 689:	b8 0b 00 00 00       	mov    $0xb,%eax
 68e:	cd 40                	int    $0x40
 690:	c3                   	ret    

00000691 <sbrk>:
SYSCALL(sbrk)
 691:	b8 0c 00 00 00       	mov    $0xc,%eax
 696:	cd 40                	int    $0x40
 698:	c3                   	ret    

00000699 <sleep>:
SYSCALL(sleep)
 699:	b8 0d 00 00 00       	mov    $0xd,%eax
 69e:	cd 40                	int    $0x40
 6a0:	c3                   	ret    

000006a1 <uptime>:
SYSCALL(uptime)
 6a1:	b8 0e 00 00 00       	mov    $0xe,%eax
 6a6:	cd 40                	int    $0x40
 6a8:	c3                   	ret    

000006a9 <join>:
SYSCALL(join)
 6a9:	b8 16 00 00 00       	mov    $0x16,%eax
 6ae:	cd 40                	int    $0x40
 6b0:	c3                   	ret    

000006b1 <clone>:
SYSCALL(clone)
 6b1:	b8 17 00 00 00       	mov    $0x17,%eax
 6b6:	cd 40                	int    $0x40
 6b8:	c3                   	ret    
 ...
 6cc:	89 d1                	mov    %edx,%ecx
{
 ...
 73e:	56                   	push   %esi
 73f:	57                   	push   %edi
 740:	e8 e4 fe ff ff       	call   629 <write>
  while(--i >= 0)
 ...
 779:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7b5:	57                   	push   %edi
 7b6:	56                   	push   %esi
 7b7:	e8 6d fe ff ff       	call   629 <write>
 ...
 80e:	e8 16 fe ff ff       	call   629 <write>
        putc(fd, c);
 ...
 81f:	57                   	push   %edi
 820:	56                   	push   %esi
 821:	e8 03 fe ff ff       	call   629 <write>
        putc(fd, c);
 ...
 88b:	57                   	push   %edi
 88c:	56                   	push   %esi
 88d:	e8 97 fd ff ff       	call   629 <write>
        while(*s != 0){
 ...
 8cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8cf:	e8 55 fd ff ff       	call   629 <write>
        ap++;
...
free(void *ap)
{
 ...
 911:	a1 40 13 00 00       	mov    0x1340,%eax
{
 ...
 951:	5b                   	pop    %ebx
  freep = p;
 952:	89 15 40 13 00 00    	mov    %edx,0x1340
}
 958:	5e                   	pop    %esi
 959:	5f                   	pop    %edi
 95a:	5d                   	pop    %ebp
 ...
 989:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 98c:	89 15 40 13 00 00    	mov    %edx,0x1340
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9ac:	8b 3d 40 13 00 00    	mov    0x1340,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9ef:	73 4f                	jae    a40 <malloc+0xa0>
    ...
    if(p == freep)
 9f1:	8b 3d 40 13 00 00    	mov    0x1340,%edi
 ...
 a03:	e8 89 fc ff ff       	call   691 <sbrk>
  if(p == (char*)-1)
 ...
 a1a:	e8 f1 fe ff ff       	call   910 <free>
  return freep;
 a1f:	8b 15 40 13 00 00    	mov    0x1340,%edx
 ...
 a4c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a4f:	89 15 40 13 00 00    	mov    %edx,0x1340
}
 ...
 a5f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a60:	c7 05 40 13 00 00 44 	movl   $0x1344,0x1340
 a67:	13 00 00 
    base.s.size = 0;
 a6a:	bf 44 13 00 00       	mov    $0x1344,%edi
    base.s.ptr = freep = prevp = &base;
 a6f:	c7 05 44 13 00 00 44 	movl   $0x1344,0x1344
 a76:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a79:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a7b:	c7 05 48 13 00 00 00 	movl   $0x0,0x1348
 a82:	00 00 00 
    if(p->s.size >= nunits){
