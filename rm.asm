...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 2f 03 00 00       	call   369 <unlink>
  ...
  exit();
  4b:	e8 c9 02 00 00       	call   319 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 0e 04 00 00       	call   480 <printf>
    exit();
  72:	e8 a2 02 00 00       	call   319 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 74 01 00 00       	call   331 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 37 01 00 00       	call   359 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 3a 01 00 00       	call   371 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 00 01 00 00       	call   341 <close>
  return r;
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 44e:	56                   	push   %esi
 44f:	57                   	push   %edi
 450:	e8 e4 fe ff ff       	call   339 <write>
  while(--i >= 0)
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c5:	57                   	push   %edi
 4c6:	56                   	push   %esi
 4c7:	e8 6d fe ff ff       	call   339 <write>
 ...
 51e:	e8 16 fe ff ff       	call   339 <write>
        putc(fd, c);
 ...
 52f:	57                   	push   %edi
 530:	56                   	push   %esi
 531:	e8 03 fe ff ff       	call   339 <write>
        putc(fd, c);
 ...
 59b:	57                   	push   %edi
 59c:	56                   	push   %esi
 59d:	e8 97 fd ff ff       	call   339 <write>
        while(*s != 0){
 ...
 5dc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5df:	e8 55 fd ff ff       	call   339 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 713:	e8 89 fc ff ff       	call   3a1 <sbrk>
  if(p == (char*)-1)
