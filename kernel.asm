...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 ba 7a 10 80 	movl   $0x80107aba,(%esp)
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 a2 5b 10 80 	movl   $0x80105ba2,0x14(%eax)
  p->context = (struct context*)sp;
...
80103b1e:	e8 cd fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b23:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80103b29:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  popcli();
80103b2c:	e8 ff 0b 00 00       	call   80104730 <popcli>
  if (((uint) stack % PGSIZE) != 0)
80103b31:	f7 45 14 ff 0f 00 00 	testl  $0xfff,0x14(%ebp)
80103b38:	0f 85 04 01 00 00    	jne    80103c42 <clone+0x132>
  if((np = allocproc()) == 0)
80103b3e:	e8 6d fc ff ff       	call   801037b0 <allocproc>
80103b43:	89 c3                	mov    %eax,%ebx
80103b45:	85 c0                	test   %eax,%eax
80103b47:	0f 84 f5 00 00 00    	je     80103c42 <clone+0x132>
  np->pgdir = curproc->pgdir; 
80103b4d:	8b 7d d4             	mov    -0x2c(%ebp),%edi
  stackArr[0] = 0xffffffff; // Fake return PC 
80103b50:	c7 45 dc ff ff ff ff 	movl   $0xffffffff,-0x24(%ebp)
  np->pgdir = curproc->pgdir; 
80103b57:	8b 47 04             	mov    0x4(%edi),%eax
...
80103b60:	6a 0c                	push   $0xc
  stackArr[1] = (uint) arg1; 
80103b62:	89 45 e0             	mov    %eax,-0x20(%ebp)
  stackArr[2] = (uint) arg2; 
80103b65:	8b 45 10             	mov    0x10(%ebp),%eax
80103b68:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  stackPtr = stackPtr - 12; 
80103b6b:	8b 45 14             	mov    0x14(%ebp),%eax
80103b6e:	8d 90 f4 0f 00 00    	lea    0xff4(%eax),%edx
  if (copyout(np->pgdir, stackPtr, stackArr, 12) < 0)
80103b74:	8d 45 dc             	lea    -0x24(%ebp),%eax
80103b77:	50                   	push   %eax
80103b78:	52                   	push   %edx
80103b79:	ff 73 04             	push   0x4(%ebx)
80103b7c:	89 55 d0             	mov    %edx,-0x30(%ebp)
80103b7f:	e8 7c 38 00 00       	call   80107400 <copyout>
80103b84:	83 c4 10             	add    $0x10,%esp
80103b87:	85 c0                	test   %eax,%eax
80103b89:	0f 88 b3 00 00 00    	js     80103c42 <clone+0x132>
  np->sz = curproc->sz;
80103b8f:	8b 07                	mov    (%edi),%eax
  *np->tf = *curproc->tf;
80103b91:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->tf->esp = (uint) stackPtr; 
80103b96:	8b 55 d0             	mov    -0x30(%ebp),%edx
  np->parent = curproc;
80103b99:	89 7b 14             	mov    %edi,0x14(%ebx)
  *np->tf = *curproc->tf;
80103b9c:	89 7d d4             	mov    %edi,-0x2c(%ebp)
  np->sz = curproc->sz;
80103b9f:	89 03                	mov    %eax,(%ebx)
  np->userStack = stack; 
80103ba1:	8b 45 14             	mov    0x14(%ebp),%eax
  *np->tf = *curproc->tf;
80103ba4:	8b 77 18             	mov    0x18(%edi),%esi
80103ba7:	8b 7b 18             	mov    0x18(%ebx),%edi
80103baa:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->userStack = stack; 
80103bac:	89 43 7c             	mov    %eax,0x7c(%ebx)
  np->tf->eip = (uint) fcn; 
80103baf:	8b 4d 08             	mov    0x8(%ebp),%ecx
  for(i = 0; i < NOFILE; i++)
80103bb2:	31 f6                	xor    %esi,%esi
80103bb4:	8b 7d d4             	mov    -0x2c(%ebp),%edi
  np->tf->eax = 0;
80103bb7:	8b 43 18             	mov    0x18(%ebx),%eax
80103bba:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  np->tf->esp = (uint) stackPtr; 
80103bc1:	8b 43 18             	mov    0x18(%ebx),%eax
80103bc4:	89 50 44             	mov    %edx,0x44(%eax)
  np->tf->eip = (uint) fcn; 
80103bc7:	8b 43 18             	mov    0x18(%ebx),%eax
80103bca:	89 48 38             	mov    %ecx,0x38(%eax)
  for(i = 0; i < NOFILE; i++)
80103bcd:	8d 76 00             	lea    0x0(%esi),%esi
    if(curproc->ofile[i])
80103bd0:	8b 44 b7 28          	mov    0x28(%edi,%esi,4),%eax
80103bd4:	85 c0                	test   %eax,%eax
80103bd6:	74 10                	je     80103be8 <clone+0xd8>
...
80103bee:	75 e0                	jne    80103bd0 <clone+0xc0>
  np->cwd = idup(curproc->cwd);
80103bf0:	8b 7d d4             	mov    -0x2c(%ebp),%edi
80103bf3:	83 ec 0c             	sub    $0xc,%esp
80103bf6:	ff 77 68             	push   0x68(%edi)
80103bf9:	e8 52 db ff ff       	call   80101750 <idup>
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bfe:	83 c4 0c             	add    $0xc,%esp
80103c01:	8d 57 6c             	lea    0x6c(%edi),%edx
  np->cwd = idup(curproc->cwd);
80103c04:	89 43 68             	mov    %eax,0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103c07:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103c0a:	6a 10                	push   $0x10
80103c0c:	52                   	push   %edx
80103c0d:	50                   	push   %eax
80103c0e:	e8 9d 0e 00 00       	call   80104ab0 <safestrcpy>
  pid = np->pid;
80103c13:	8b 73 10             	mov    0x10(%ebx),%esi
  acquire(&ptable.lock);
80103c16:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103c1d:	e8 0e 0c 00 00       	call   80104830 <acquire>
  np->state = RUNNABLE;
80103c22:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103c29:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103c30:	e8 9b 0b 00 00       	call   801047d0 <release>
  return pid;
...
80103c47:	eb ef                	jmp    80103c38 <clone+0x128>
...
80103c56:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103c59:	e8 82 0a 00 00       	call   801046e0 <pushcli>
  c = mycpu();
80103c5e:	e8 8d fc ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103c63:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c69:	e8 c2 0a 00 00       	call   80104730 <popcli>
  if((np = allocproc()) == 0){
...
80103c88:	e8 f3 35 00 00       	call   80107280 <copyuvm>
...
80103d9e:	e8 8d 0a 00 00       	call   80104830 <acquire>
...
80103dc0:	e8 6b 2f 00 00       	call   80106d30 <switchuvm>
...
80103dcb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103dd2:	e8 34 0d 00 00       	call   80104b0b <swtch>
      switchkvm();
80103dd7:	e8 44 2f 00 00       	call   80106d20 <switchkvm>
      c->proc = 0;
...
80103dfc:	e8 cf 09 00 00       	call   801047d0 <release>
    sti();
...
80103e73:	e8 93 0c 00 00       	call   80104b0b <swtch>
  mycpu()->intena = intena;
...
80103f3a:	e8 f1 08 00 00       	call   80104830 <acquire>
...
80103f81:	eb 18                	jmp    80103f9b <exit+0xcb>
...
80103f8e:	74 10                	je     80103fa0 <exit+0xd0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f90:	83 ea 80             	sub    $0xffffff80,%edx
80103f93:	81 fa 54 3d 11 80    	cmp    $0x80113d54,%edx
80103f99:	74 33                	je     80103fce <exit+0xfe>
    if(p->parent == curproc || p->pgdir == curproc->pgdir){ // Added this P3B 
80103f9b:	39 5a 14             	cmp    %ebx,0x14(%edx)
80103f9e:	75 e8                	jne    80103f88 <exit+0xb8>
      if(p->state == ZOMBIE)
...
80103fa7:	75 e7                	jne    80103f90 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fa9:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
...
80103fdd:	68 a8 7a 10 80       	push   $0x80107aa8
80103fe2:	e8 99 c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103fe7:	83 ec 0c             	sub    $0xc,%esp
80103fea:	68 9b 7a 10 80       	push   $0x80107a9b
...
80104004:	53                   	push   %ebx
  pushcli();
80104005:	e8 d6 06 00 00       	call   801046e0 <pushcli>
  c = mycpu();
8010400a:	e8 e1 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010400f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104015:	e8 16 07 00 00       	call   80104730 <popcli>
  cprintf("HERE1!\n");
8010401a:	83 ec 0c             	sub    $0xc,%esp
8010401d:	68 b4 7a 10 80       	push   $0x80107ab4
80104022:	e8 79 c6 ff ff       	call   801006a0 <cprintf>
  acquire(&ptable.lock);
80104027:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010402e:	e8 fd 07 00 00       	call   80104830 <acquire>
80104033:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80104036:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104038:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
8010403d:	eb 0c                	jmp    8010404b <join+0x4b>
8010403f:	90                   	nop
80104040:	83 eb 80             	sub    $0xffffff80,%ebx
80104043:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
80104049:	74 2b                	je     80104076 <join+0x76>
      if(p->parent != curproc) //|| p->pgdir != curproc->pgdir)
8010404b:	39 73 14             	cmp    %esi,0x14(%ebx)
8010404e:	75 f0                	jne    80104040 <join+0x40>
      cprintf("HERE2!\n"); 
80104050:	83 ec 0c             	sub    $0xc,%esp
80104053:	68 bc 7a 10 80       	push   $0x80107abc
80104058:	e8 43 c6 ff ff       	call   801006a0 <cprintf>
      if(p->state == ZOMBIE){
8010405d:	83 c4 10             	add    $0x10,%esp
80104060:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104064:	74 62                	je     801040c8 <join+0xc8>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104066:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
80104069:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010406e:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
80104074:	75 d5                	jne    8010404b <join+0x4b>
    if(!havekids || curproc->killed){
80104076:	85 c0                	test   %eax,%eax
80104078:	0f 84 ab 00 00 00    	je     80104129 <join+0x129>
8010407e:	8b 46 24             	mov    0x24(%esi),%eax
80104081:	85 c0                	test   %eax,%eax
80104083:	0f 85 a0 00 00 00    	jne    80104129 <join+0x129>
  pushcli();
80104089:	e8 52 06 00 00       	call   801046e0 <pushcli>
  c = mycpu();
8010408e:	e8 5d f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104093:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104099:	e8 92 06 00 00       	call   80104730 <popcli>
  if(p == 0)
8010409e:	85 db                	test   %ebx,%ebx
801040a0:	0f 84 9a 00 00 00    	je     80104140 <join+0x140>
  p->chan = chan;
801040a6:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
801040a9:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801040b0:	e8 5b fd ff ff       	call   80103e10 <sched>
  p->chan = 0;
801040b5:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
801040bc:	e9 75 ff ff ff       	jmp    80104036 <join+0x36>
801040c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        cprintf("HERE3!\n"); 
801040c8:	83 ec 0c             	sub    $0xc,%esp
801040cb:	68 c4 7a 10 80       	push   $0x80107ac4
...
801040d6:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
801040d9:	ff 73 08             	push   0x8(%ebx)
801040dc:	e8 df e3 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
801040e1:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040e8:	59                   	pop    %ecx
801040e9:	ff 73 04             	push   0x4(%ebx)
801040ec:	e8 1f 30 00 00       	call   80107110 <freevm>
        p->pid = 0;
801040f1:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
801040f8:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801040ff:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104103:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
8010410a:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104111:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80104118:	e8 b3 06 00 00       	call   801047d0 <release>
        return pid;
...
80104129:	83 ec 0c             	sub    $0xc,%esp
      return -1;
8010412c:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104131:	68 20 1d 11 80       	push   $0x80111d20
80104136:	e8 95 06 00 00       	call   801047d0 <release>
      return -1;
8010413b:	83 c4 10             	add    $0x10,%esp
8010413e:	eb e0                	jmp    80104120 <join+0x120>
    panic("sleep");
80104140:	83 ec 0c             	sub    $0xc,%esp
80104143:	68 cc 7a 10 80       	push   $0x80107acc
80104148:	e8 33 c2 ff ff       	call   80100380 <panic>
...
801041b6:	8b 46 24             	mov    0x24(%esi),%eax
...
801041d8:	0f 84 8f 00 00 00    	je     8010426d <wait+0x11d>
  p->chan = chan;
801041de:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
801041e1:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801041e8:	e8 23 fc ff ff       	call   80103e10 <sched>
  p->chan = 0;
801041ed:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
...
80104209:	e8 b2 e2 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
8010420e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104215:	5a                   	pop    %edx
80104216:	ff 73 04             	push   0x4(%ebx)
80104219:	e8 f2 2e 00 00       	call   80107110 <freevm>
        p->pid = 0;
...
80104237:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010423e:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
80104259:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010425e:	68 20 1d 11 80       	push   $0x80111d20
...
80104270:	68 cc 7a 10 80       	push   $0x80107acc
...
801042a6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
801042ad:	e8 5e fb ff ff       	call   80103e10 <sched>
  release(&ptable.lock);
...
80104320:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104327:	e8 e4 fa ff ff       	call   80103e10 <sched>
  p->chan = 0;
...
8010435b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104362:	e8 a9 fa ff ff       	call   80103e10 <sched>
  p->chan = 0;
...
80104379:	68 d2 7a 10 80       	push   $0x80107ad2
8010437e:	e8 fd bf ff ff       	call   80100380 <panic>
    panic("sleep");
80104383:	83 ec 0c             	sub    $0xc,%esp
80104386:	68 cc 7a 10 80       	push   $0x80107acc
...
80104479:	bb c0 1d 11 80       	mov    $0x80111dc0,%ebx
...
801044ac:	74 ea                	je     80104498 <procdump+0x28>
      state = "???";
801044ae:	ba e3 7a 10 80       	mov    $0x80107ae3,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801044b3:	83 f8 05             	cmp    $0x5,%eax
801044b6:	77 11                	ja     801044c9 <procdump+0x59>
801044b8:	8b 14 85 44 7b 10 80 	mov    -0x7fef84bc(,%eax,4),%edx
      state = "???";
801044bf:	b8 e3 7a 10 80       	mov    $0x80107ae3,%eax
...
801044ce:	68 e7 7a 10 80       	push   $0x80107ae7
...
8010453a:	68 5c 7b 10 80       	push   $0x80107b5c
...
80104775:	68 67 7b 10 80       	push   $0x80107b67
8010477a:	e8 01 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010477f:	83 ec 0c             	sub    $0xc,%esp
80104782:	68 7e 7b 10 80       	push   $0x80107b7e
...
801047eb:	68 85 7b 10 80       	push   $0x80107b85
...
801048e0:	68 8d 7b 10 80       	push   $0x80107b8d
...
80104d38:	68 95 7b 10 80       	push   $0x80107b95
...
80105926:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105929:	6a 04                	push   $0x4
8010592b:	50                   	push   %eax
8010592c:	6a 00                	push   $0x0
8010592e:	e8 cd f2 ff ff       	call   80104c00 <argptr>
80105933:	83 c4 10             	add    $0x10,%esp
80105936:	85 c0                	test   %eax,%eax
80105938:	78 5e                	js     80105998 <sys_clone+0x78>
8010593a:	83 ec 04             	sub    $0x4,%esp
8010593d:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105940:	6a 04                	push   $0x4
80105942:	50                   	push   %eax
80105943:	6a 01                	push   $0x1
80105945:	e8 b6 f2 ff ff       	call   80104c00 <argptr>
8010594a:	83 c4 10             	add    $0x10,%esp
8010594d:	85 c0                	test   %eax,%eax
8010594f:	78 47                	js     80105998 <sys_clone+0x78>
...
8010595a:	6a 02                	push   $0x2
8010595c:	e8 9f f2 ff ff       	call   80104c00 <argptr>
  if ((argptr(0, (void*)&fcn, sizeof(void*)) < 0) || (argptr(1, (void*)&arg1, sizeof(void*)) < 0) || 
80105961:	83 c4 10             	add    $0x10,%esp
80105964:	85 c0                	test   %eax,%eax
80105966:	78 30                	js     80105998 <sys_clone+0x78>
      (argptr(2, (void*)&arg2, sizeof(void*)) < 0) || (argptr(3, (void*)&stack, sizeof(void*)) < 0)) 
...
80105973:	e8 88 f2 ff ff       	call   80104c00 <argptr>
80105978:	83 c4 10             	add    $0x10,%esp
8010597b:	85 c0                	test   %eax,%eax
8010597d:	78 19                	js     80105998 <sys_clone+0x78>
        return -1; 

  return clone(fcn, arg1, arg2, stack); 
8010597f:	ff 75 f4             	push   -0xc(%ebp)
80105982:	ff 75 f0             	push   -0x10(%ebp)
80105985:	ff 75 ec             	push   -0x14(%ebp)
80105988:	ff 75 e8             	push   -0x18(%ebp)
8010598b:	e8 80 e1 ff ff       	call   80103b10 <clone>
...
{
  return fork();
801059a0:	e9 ab e2 ff ff       	jmp    80103c50 <fork>
...
801059f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801059f6:	e8 d5 e4 ff ff       	call   80103ed0 <exit>
...
{
  return wait();
80105a00:	e9 4b e7 ff ff       	jmp    80104150 <wait>
...
80105a1c:	e8 8f f1 ff ff       	call   80104bb0 <argint>
...
80105a2e:	e8 bd e9 ff ff       	call   801043f0 <kill>
...
80105a6d:	e8 3e f1 ff ff       	call   80104bb0 <argint>
...
80105a86:	e8 05 e0 ff ff       	call   80103a90 <growproc>
...
80105abd:	e8 ee f0 ff ff       	call   80104bb0 <argint>
...
80105ad0:	68 80 3d 11 80       	push   $0x80113d80
80105ad5:	e8 56 ed ff ff       	call   80104830 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105ada:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105add:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
80105af3:	68 80 3d 11 80       	push   $0x80113d80
80105af8:	68 60 3d 11 80       	push   $0x80113d60
80105afd:	e8 ce e7 ff ff       	call   801042d0 <sleep>
  while(ticks - ticks0 < n){
80105b02:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
80105b25:	e8 a6 ec ff ff       	call   801047d0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105b48:	e8 83 ec ff ff       	call   801047d0 <release>
  return 0;
...
80105b64:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b67:	68 80 3d 11 80       	push   $0x80113d80
80105b6c:	e8 bf ec ff ff       	call   80104830 <acquire>
  xticks = ticks;
80105b71:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
80105b77:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105b7e:	e8 4d ec ff ff       	call   801047d0 <release>
  return xticks;
}
...
80105bfe:	00 00 ef 
  initlock(&tickslock, "time");
80105c01:	68 81 7c 10 80       	push   $0x80107c81
...
80105c84:	ff 24 85 28 7d 10 80 	jmp    *-0x7fef82d8(,%eax,4)
...
80105d65:	68 e4 7c 10 80       	push   $0x80107ce4
...
80105db7:	68 8c 7c 10 80       	push   $0x80107c8c
...
80105e13:	5d                   	pop    %ebp
      exit();
80105e14:	e9 b7 e0 ff ff       	jmp    80103ed0 <exit>
...
80105ed3:	68 b0 7c 10 80       	push   $0x80107cb0
80105ed8:	e8 c3 a7 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105edd:	83 c4 14             	add    $0x14,%esp
80105ee0:	68 86 7c 10 80       	push   $0x80107c86
...
80105f8c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105f8f:	bf a8 7d 10 80       	mov    $0x80107da8,%edi
...
80106c7d:	68 b0 7d 10 80       	push   $0x80107db0
...
80106eab:	68 f5 7d 10 80       	push   $0x80107df5
...
80106f10:	68 0f 7e 10 80       	push   $0x80107e0f
...
80106f98:	68 b0 7e 10 80       	push   $0x80107eb0
...
80107039:	68 2d 7e 10 80       	push   $0x80107e2d
...
8010709b:	68 45 7e 10 80       	push   $0x80107e45
...
8010717c:	68 61 7e 10 80       	push   $0x80107e61
...
8010724c:	68 72 7e 10 80       	push   $0x80107e72
...
801072c2:	68 7c 7e 10 80       	push   $0x80107e7c
...
80107397:	68 96 7e 10 80       	push   $0x80107e96
