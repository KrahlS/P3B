...
main(int argc, char *argv[])
{
  ...
  59:	e8 e3 03 00 00       	call   441 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 ae 03 00 00       	call   419 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 06 05 00 00       	call   580 <printf>
      exit();
  7a:	e8 9a 03 00 00       	call   419 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 87 03 00 00       	call   419 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 5c 03 00 00       	call   431 <read>
 ...
 16f:	e8 0c 04 00 00       	call   580 <printf>
    exit();
 174:	e8 a0 02 00 00       	call   419 <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 74 01 00 00       	call   431 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 37 01 00 00       	call   459 <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 3a 01 00 00       	call   471 <fstat>
  close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 00 01 00 00       	call   441 <close>
  return r;
 ...
 589:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c5:	57                   	push   %edi
 5c6:	56                   	push   %esi
 5c7:	e8 6d fe ff ff       	call   439 <write>
 ...
 61e:	e8 16 fe ff ff       	call   439 <write>
        putc(fd, c);
 ...
 62f:	57                   	push   %edi
 630:	56                   	push   %esi
 631:	e8 03 fe ff ff       	call   439 <write>
        putc(fd, c);
 ...
 69b:	57                   	push   %edi
 69c:	56                   	push   %esi
 69d:	e8 97 fd ff ff       	call   439 <write>
        while(*s != 0){
 ...
 6dc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6df:	e8 55 fd ff ff       	call   439 <write>
        ap++;
...
free(void *ap)
{
 ...
 721:	a1 a0 0e 00 00       	mov    0xea0,%eax
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 768:	5e                   	pop    %esi
 769:	5f                   	pop    %edi
 76a:	5d                   	pop    %ebp
 ...
 799:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 79c:	89 15 a0 0e 00 00    	mov    %edx,0xea0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 3d a0 0e 00 00    	mov    0xea0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 4f                	jae    850 <malloc+0xa0>
    ...
    if(p == freep)
 801:	8b 3d a0 0e 00 00    	mov    0xea0,%edi
 ...
 813:	e8 89 fc ff ff       	call   4a1 <sbrk>
  if(p == (char*)-1)
 ...
 82a:	e8 f1 fe ff ff       	call   720 <free>
  return freep;
 82f:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
 ...
 85c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 85f:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 ...
 86f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 a0 0e 00 00 a4 	movl   $0xea4,0xea0
 877:	0e 00 00 
    base.s.size = 0;
 87a:	bf a4 0e 00 00       	mov    $0xea4,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 a4 0e 00 00 a4 	movl   $0xea4,0xea4
 886:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 88b:	c7 05 a8 0e 00 00 00 	movl   $0x0,0xea8
 892:	00 00 00 
    if(p->s.size >= nunits){
