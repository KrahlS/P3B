...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 ab 02 00 00       	call   2c1 <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 35 03 00 00       	call   359 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 9d 02 00 00       	call   2c9 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 159:	31 db                	xor    %ebx,%ebx
{
 ...
 165:	57                   	push   %edi
 166:	6a 00                	push   $0x0
 168:	e8 74 01 00 00       	call   2e1 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 37 01 00 00       	call   309 <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 3a 01 00 00       	call   321 <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 00 01 00 00       	call   2f1 <close>
  return r;
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3fe:	56                   	push   %esi
 3ff:	57                   	push   %edi
 400:	e8 e4 fe ff ff       	call   2e9 <write>
  while(--i >= 0)
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 475:	57                   	push   %edi
 476:	56                   	push   %esi
 477:	e8 6d fe ff ff       	call   2e9 <write>
 ...
 4ce:	e8 16 fe ff ff       	call   2e9 <write>
        putc(fd, c);
 ...
 4df:	57                   	push   %edi
 4e0:	56                   	push   %esi
 4e1:	e8 03 fe ff ff       	call   2e9 <write>
        putc(fd, c);
 ...
 54b:	57                   	push   %edi
 54c:	56                   	push   %esi
 54d:	e8 97 fd ff ff       	call   2e9 <write>
        while(*s != 0){
 ...
 58c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 58f:	e8 55 fd ff ff       	call   2e9 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6c3:	e8 89 fc ff ff       	call   351 <sbrk>
  if(p == (char*)-1)
